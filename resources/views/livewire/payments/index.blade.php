    ...
    <div class="mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden transition-colors duration-200">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-1">List of all payments</p>
            </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    @each('livewire.payments.payment-item', $this->payments, 'payment', 'livewire.payments.payment-item-empty')
                </tbody>
            </table>
            <div class="p-5">
                {{ $this->payments->links() }}
